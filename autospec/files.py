    ...
    def push_file(self, filename, pkg_name):
        ...
        if self.package_name == "gcc":
            patterns_gcc = [
                ...
                (r"^/usr/lib/rpm[a-zA-Z0-9\.\_\+\-\/]*/[a-zA-Z0-9\.\_\+\-\/]*$", "main"),
                # main
                (r"^/usr/bin/x86_64-generic-linux-gcc-ar$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-gcc-ranlib$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-gcc-nm$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-gcc$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-c\+\+$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-gcc-\d+$", "main"),
                (r"^/usr/bin/gcc$", "main"),
                (r"^/usr/bin/cc$", "main"),
                ...
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/include-fixed/", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/install-tools/", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/libcaf_[a-zA-Z0-9\.\_\+\-\/]*$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/include/", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/lto1$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/lto-wrapper$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/collect2$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/cc1plus$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/g\+\+-mapper-server$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/cc1$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/plugin/gtype\.state$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/plugin/[a-zA-Z0-9\.\_\+\-]*\.so[0-9\.]*", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/plugin/include/", "main"),
                (r"^/usr/share/gcc-\d+$", "main"),
                (r"^/usr/lib64/[a-zA-Z0-9\.\_\+\-]*\.[ao]$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtbegin\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtbeginS\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtbeginT\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtend\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtendS\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtfastmath\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtprec32\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtprec64\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/crtprec80\.o$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/libgcc\.a$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/libgcc_eh\.a$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/libgcov\.a$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-gfortran$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/f951$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/finclude", "main"),
                (r"^/usr/bin/f95$", "main"),
                (r"^/usr/bin/gfortran$", "main"),
                (r"^/usr/bin/x86_64-generic-linux-g\+\+$", "main"),
                (r"^/usr/bin/c\+\+$", "main"),
                (r"^/usr/bin/g\+\+$", "main"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/liblto_plugin.so$", "main"),
                # dev
                (r"^/usr/lib64/libgcc_s\.so$", "dev"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/include/ssp", "dev"),
                ...
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/plugin/gengtype$", "dev"),
                ...
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/finclude", "dev"),
                ...
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtbegin\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtbeginS\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtbeginT\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtend\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtendS\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtfastmath\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtprec32\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtprec64\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/crtprec80\.o$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/finclude/ieee_arithmetic\.mod$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/finclude/ieee_exceptions\.mod$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/finclude/ieee_features\.mod$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/libcaf_single\.a$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/libgcc\.a$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/libgcc_eh\.a$", "dev32"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/32/libgcov\.a$", "dev32"),
                ...
                # go
                (r"^/usr/bin/gccgo$", "go"),
                (r"^/usr/bin/x86_64-generic-linux-gccgo$", "go"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/buildid$", "go"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/cgo$", "go"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/go1$", "go"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/test2json$", "go"),
                (r"^/usr/lib64/gcc/x86_64-generic-linux/\d+/vet$", "go"),
                ...
                (r"^/usr/lib64/go/\d+/x86_64-generic-linux/[a-zA-Z0-9\.\_\+\-\/]*\.gox$", "go-lib"),
                # libubsan
